...
DuAEUI.bgColors = {
  /* @ts-ignore */
  DARKEST: new DuColor([
    0.11328125, 0.11328125, 0.11328125, 1,
  ]) /* @ts-ignore */,
  DARK: new DuColor([0.1953125, 0.1953125, 0.1953125, 1]) /* @ts-ignore */,
  LIGHT: new DuColor([0.96875, 0.96875, 0.96875, 1]) /* @ts-ignore */,
};
...
/* @ts-ignore */
DuAEUI.textColors = {
  /* @ts-ignore */ DARK: new DuColor([1, 1, 1, 1]) /* @ts-ignore */,
  DARK_REDUCED: new DuColor([
    0.6953125, 0.6953125, 0.6953125, 1,
  ]) /* @ts-ignore */,
  LIGHT: new DuColor([0, 0, 0, 1]) /* @ts-ignore */,
  LIGHT_REDUCED: new DuColor([0.42578125, 0.42578125, 0.42578125, 1]),
};
...
DuAEUI.isDark = function () {
  return (
    DuAEUI.brightness() > DuAEUI.brightnessLimits.DARK &&
