...
DuAEShapeLayer.getTransformMatrix = function (prop, includeLayerTransform) {
  ...
  if (includeLayerTransform)
    matrix = DuAELayer.getTransformMatrix(propInfo.layer);
...
DuAEShapeLayer.isSingleShape = function (layer) {
  ...
  if (
    path.matchName != "ADBE Vector Shape - Group" &&
    path.matchName != "ADBE Vector Shape - Rect" &&
    path.matchName != "ADBE Vector Shape - Ellipse" &&
    path.matchName != "ADBE Vector Shape - Star"
  )
    return false;
